...
class UpdateLeagueRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('leagues', 'name')->ignore($this->league->id),
            ],
            'slug' => [
                'nullable',
                'string',
                'max:255',
                Rule::unique('leagues', 'slug')->ignore($this->league->id),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'A league with this name already exists.',
            'slug.unique' => 'A league with this URL slug already exists.',
