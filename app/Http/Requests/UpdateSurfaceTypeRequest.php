    ...
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('surface_types', 'name')->ignore($this->surface_type->id),
            ],
            'slug' => [
                'nullable',
                'string',
                'max:255',
                Rule::unique('surface_types', 'slug')->ignore($this->surface_type->id),
            ],
            'code' => [
                'nullable',
                'string',
                'max:10',
                Rule::unique('surface_types', 'code')->ignore($this->surface_type->id),
            ],
