                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="space-y-4 border-t pt-6">
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Define available sizes for products in this category (e.g., 39, 40, 41 for boots or S, M, L for jerseys)
                                </p>
                            </div>
                            ...
                            <div class="flex gap-4">
                                <div class="flex-1">
                                    <Input v-model="newSizeValue" placeholder="Size value (e.g., 39, M)" @keyup.enter="addVariantSize" />
                                </div>
                                <div class="flex-1">
                                    <Input v-model="newSizeLabel" placeholder="Display label (e.g., EU 39, Medium)" @keyup.enter="addVariantSize" />
                                </div>
                                <Button type="button" @click="addVariantSize" :disabled="!newSizeValue || !newSizeLabel">
                            ...
                            <div v-if="form.variant_sizes.length > 0" class="space-y-2">
                                <div v-for="(size, index) in form.variant_sizes" :key="index" class="flex items-center justify-between rounded-md border p-3">
                                    <div class="flex-1">
